...
protein_validation_test_new = [["5o2j","A","5o2k","E","2PO"],["6hbd","A","6hb0","A","GZL"],["5ota","A","4p0i","B","AQQ"], \
["1lah","E","2lao","A","ORN"],["4r74","D","4r72","A","F6P"],["2dri","A","1urp","A","RIP"],["2gga","A","2gg4","A","GPJ:S3P"], \
["3ttn","B","3ttl","A","SPD"],["1rpj","A","1gud","B","ALL"],["5yyb","A","5za4","A","NGE"],["6qcn","B","1j8f","C","AR6"], \
["1u2s","A","1s2o","A","GLC"],["3uh1","A","3ugk","A","NAI:SHR"],["5g3r","A","5g1m","A","89A:NAG"],["4ocp","A","4wh1","A","GN1:ADP-Mg"], \
["1z4o","A","6h8v","B","GL1"],["6h76","A","2cey","A","SLB"],["2vpn","B","3gyy","C","4CS"],["5igy","A","5uxa","A","GDP-Ca, ERY"], \
["2oeg","A","5nzm","A","UPG"],["1tjy","A","1tm2","A","PAV"],["1qkj","A","1jej","A","UDP"],["1kmp","A","1kmo","A","CIT-2Fe"], \
["2cgl","A","2cgk","A","ADP:LFR"],["3ppr","B","3ppn","A","4CS"],["3dbk","A","1ezm","A","RDF"],["4v3b","A","4v38","A","C"], \
["5ni6","A","5nia","A","DJ3"],["3kjg","A","3kje","A","ADP"],["5xdt","A","6rvm","C","ZI7-Ca"],["2p70","A","2fjy","A","PRZ"], \
["6i11","A","3p53","A","H0H"],["1y1a","B","1y1a","A","GSH"], \
["2w9s","C","2w9t","A","NDP:TOP"],["4psq","B","1brq","A","2WL"],["2b03","A","3fvj","A","TUD"],["5osz","A","6ypk","A","AHK403"], \
["2hps","A","2hq8","B","CTZ"]]

#all_cs_apos = [i[0] for i in all_cs_structures]
all_cs_holos_withdimers = [i[2] for i in protein_validation_test_new]
all_cs_holos = []
...
for i in range(len(all_ns_holos)):
    ...
    #check for sequence identity within new refiltered proteins
    if False:
    ...
    for j in range(len(all_cs_holos)):
        ...
        fasta_seq2 = SeqIO.read(open(f"rcsb_fasta_cs/{id_2.lower()}.fasta"),'fasta').seq
